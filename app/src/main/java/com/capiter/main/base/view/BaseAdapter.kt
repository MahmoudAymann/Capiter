...
abstract class BaseAdapter<T : BaseParcelable>(
    ...
    abstract fun onViewHolderCreated(binding: ViewDataBinding, viewHolder: RecyclerView.ViewHolder)
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<T> {
        ...
        return BaseViewHolder<T>(binding).apply {
            onViewHolderCreated(binding, this)
...
interface BaseParcelable {
    fun unique(): Any
    fun <T> areContentsTheSame(newItem: T): Boolean
}
